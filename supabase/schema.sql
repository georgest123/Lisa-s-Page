...
alter table public.booking_settings add column if not exists brochure_file_url text;
alter table public.booking_settings add column if not exists brochure_file_name text;
alter table public.booking_settings add column if not exists brochure_uploaded_at timestamptz;
